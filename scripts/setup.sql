...
GRANT DATABASE ROLE SNOWFLAKE.CORTEX_USER TO ROLE ZTS_DEV;
GRANT USAGE ON SCHEMA ZERO_TO_SNOWFLAKE.HARMONIZED TO ROLE ZTS_DEV;
GRANT USAGE ON WAREHOUSE ZTS_DE_WH TO ROLE ZTS_DEV;
